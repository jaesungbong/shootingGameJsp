...
<div id="sidemenu">
  ...
  <form Name="member" method="post" Action="member_ok.jsp">
  	<table align="center">
  		...
  		<BR>
  		<BR>
  		<TR><TD><B><%=name%></B>님어서오세요. <BR>당신의 최근 게임 점수는<B><%=iscore%></B></TD></TR>
  		<TR><TD align='center'>계급<br>
...
<article> 
<h1><font size="5.5" color="blue"><p align="left">희주를 구할자는 당신 뿐!!</p></font></h1>
<figure>
 <img src="air.jpg">
</figure>
<br>
...
<footer>
<p>박재성 전화:010-8809-8943 email:01048098943@naver.com<br>
